...
public class SodiumGameOptionPages {
    ...
    public static OptionPage general() {
        ...
        groups.add(OptionGroup.createBuilder()
                ...
                .add(OptionImpl.createBuilder(AttackIndicator.class, vanillaOpts)
                        ...
                        .setControl(opts -> new CyclingControl<>(opts, AttackIndicator.class, new Text[] {
                                new TranslatableText("options.off"),
                                new TranslatableText("options.attack.crosshair"),
                                new TranslatableText("options.attack.hotbar")
                        }))
    ...
    public static OptionPage advanced() {
        ...
        groups.add(OptionGroup.createBuilder()
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TranslatableText("sodium.options.use_chunk_multi-draw.name"))
                        .setTooltip(new TranslatableText("sodium.options.use_chunk_multi-draw.tooltip"))
                        .setControl(TickBoxControl::new)
                        ...
                        .build())
                .add(OptionImpl.createBuilder(boolean.class, sodiumOpts)
                        .setName(new TranslatableText("sodium.options.use_vertex_array_objects.name"))
                        .setTooltip(new TranslatableText("sodium.options.use_vertex_array_objects.tooltip"))
                        .setControl(TickBoxControl::new)
