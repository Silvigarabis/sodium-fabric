...
public class SodiumOptionsGUI extends Screen {
    ...
    private void rebuildGUI() {
        ...
        this.closeButton = new FlatButtonWidget(new Dim2i(this.width - 73, this.height - 26, 65, 20), new TranslatableText("sodium.options.buttons.close").getString(), this::onClose);
    ...
    private void renderOptionTooltip(MatrixStack matrixStack, ControlElement<?> element) {
        ...
        if (impact != null) {
            tooltip.add(Language.getInstance().reorder(new LiteralText(Formatting.GRAY + new TranslatableText("sodium.options.performance_impact_string", impact.toDisplayString()).getString())));
        }
