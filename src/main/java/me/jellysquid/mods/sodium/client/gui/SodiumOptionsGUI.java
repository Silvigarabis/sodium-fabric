...
public class SodiumOptionsGUI extends Screen {
    ...
    private void renderOptionTooltip(MatrixStack matrixStack, ControlElement<?> element) {
        ...
        if (impact != null) {
            tooltip.add(Language.getInstance().reorder(new TranslatableText("sodium.options.performance_impact_string").getString(), impact.getLocalizedName()).formatted(Formatting.GRAY)));
        }
